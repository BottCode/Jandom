...
class ExtendedSigns01DomainCoreTestSuite extends FunSuite {
  ...
  test("remainder") {
    ...
    assert(ES01Top.equals(remainder(GreaterThanOne, GreaterThanOne)))
    ...
    assert(ES01Top.equals(remainder(GreaterThanOne, Negative)))
    assert(ES01Top.equals(remainder(Negative, GreaterThanOne)))
    assert(Zero.equals(remainder(Zero, One)))
    assert(ES01Bottom.equals(remainder(One, Zero)))
    assert(Zero.equals(remainder(Zero, GreaterThanOne)))
    assert(ES01Bottom.equals(remainder(GreaterThanOne, Zero)))
    assert(One.equals(remainder(One, GreaterThanOne)))
    assert(Zero.equals(remainder(GreaterThanOne, One)))
    ...
    assert(ES01Top.equals(remainder(GreaterThanOne, ES01Top)))
    ...
    assert(ES01Top.equals(remainder(ES01Top, GreaterThanOne)))
    ...
    assert(ES01Bottom.equals(remainder(GreaterThanOne, ES01Bottom)))
    ...
    assert(ES01Bottom.equals(remainder(ES01Bottom, GreaterThanOne)))
  }
  ...
  test("compare") {
    ...
    assert(Option(0).equals(compare(GreaterThanOne, GreaterThanOne)))
    ...
    assert(Option.empty.equals(compare(GreaterThanOne, Negative)))
    assert(Option.empty.equals(compare(Negative, GreaterThanOne)))
    assert(Option.empty.equals(compare(Zero, One)))
    assert(Option.empty.equals(compare(One, Zero)))
    assert(Option.empty.equals(compare(Zero, GreaterThanOne)))
    assert(Option.empty.equals(compare(GreaterThanOne, Zero)))
    assert(Option.empty.equals(compare(One, GreaterThanOne)))
    assert(Option.empty.equals(compare(GreaterThanOne, One)))
    ...
    assert(Option(-1).equals(compare(GreaterThanOne, ES01Top)))
    ...
    assert(Option(1).equals(compare(ES01Top, GreaterThanOne)))
    ...
    assert(Option(1).equals(compare(GreaterThanOne, ES01Bottom)))
    ...
    assert(Option(-1).equals(compare(ES01Bottom, GreaterThanOne)))
  }
